...
examples/output: src/plasmo_tar_amp_schema/schema/plasmo_tar_amp_schema.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/plasmo_tar_amp_schema/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py
